...
export default function HomeHero() {
  return (
    <div className="heroContainer mx-auto flex h-[600px] w-full max-w-[1448px] overflow-hidden rounded-3xl bg-hero bg-cover bg-center bg-no-repeat 2xl:h-[700px] 2xl:items-end">
