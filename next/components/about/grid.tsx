...
export default function AboutGrid() {
  return (
    <div className="decades-info mx-auto flex h-full w-full max-w-[1448px] flex-col">
      <div>
      ...
      <div className="story-section flex w-full flex-col md:flex-row md:py-8 lg:items-center">
        <p className="story-paragraph py-8 text-center md:mr-10 md:max-h-[300px] md:w-[35%] md:text-left lg:w-[40%]">
        ...
        <picture className="sam-kacie min-h-[300px] border-stone-300 md:border-l md:pl-10">
          <Image
            className="sam-kacie-destop-img hidden min-h-[340px] rounded-3xl object-cover md:object-contain lg:my-3 lg:block lg:w-full lg:object-cover"
          ...
          />
          <Image
            className="sam-kacie-mobile-img mx-auto flex max-h-[340px] min-h-[300px] rounded-3xl object-cover lg:hidden"
      ...
      <div className="product-section flex flex-col pt-8 md:flex-row lg:items-center">
        <picture className="pillow md:border-r md:border-stone-300 md:pr-10">
          <Image
            className="pillow-deskgtop-img hidden min-h-[300px] w-full rounded-3xl object-cover md:object-contain lg:my-3 lg:block lg:w-full lg:object-cover"
          ...
          />
          <Image
            className="pillow-mobile-img mx-auto  flex min-h-[300px] rounded-3xl object-cover lg:hidden"
        ...
        <p className="story-paragraph py-8 text-center md:ml-10 md:max-h-[300px] md:w-[35%] md:py-0 md:text-left lg:w-[40%]">
