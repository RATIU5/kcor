...
export default function CTA() {
  return (
    <div className="flex w-full flex-col items-center justify-center gap-4">
      <div className="cta-img-container relative w-full h-[150px] overflow-hidden rounded-3xl sm:h-[200px] md:h-[250px] 2xl:h-[330px]">
        <Image 
      ...
      <div className="content-container">
        <h2 className="text-center text-4xl font-bold pb-4 relative z-10 text-stone-800 sm:text-5xl md:pb-6 md:pt-4">
          Dream in Elegance
        </h2>
        {/* <hr className="cta-splitter-line max-w-lg pb-4 border-stone-400/[0.5]" /> */}
        <p className="max-w-xl pb-4 text-md text-stone-800/[0.65] text-center">
